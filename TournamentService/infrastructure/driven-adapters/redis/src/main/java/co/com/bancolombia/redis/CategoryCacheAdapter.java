...
public class CategoryCacheAdapter implements CategoryCacheGateway {

    private static final String KEY_PREFIX = Constants.CATEGORY_KEY_PREFIX;
    private final ReactiveRedisTemplate<String, String> redisTemplate;

    @Value("${cache.category.ttl-seconds:300}")
    ...
    public Mono<Boolean> getExistence(Integer id) {
        return redisTemplate.opsForValue()
                ...
                .doOnNext(value -> log.info("[REDIS] categoryId={} -> exists={}", id, value))
                .doOnSuccess(value -> {
                    if (value == null) log.debug("[REDIS MISS] categoryId={}", id);
                });
    }
